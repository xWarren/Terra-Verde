...
class OfficialsShimmer extends StatefulWidget {

  const OfficialsShimmer({
    super.key,
  ...
  @override
  State<OfficialsShimmer> createState() => _OfficialsShimmerState();
}

class _OfficialsShimmerState extends State<OfficialsShimmer> {
  @override
