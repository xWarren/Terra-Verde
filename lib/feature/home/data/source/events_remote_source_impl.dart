...
import '../model/feature_events_response_data_model.dart';
...
class EventsRemoteSourceImpl extends BaseGetConnect implements EventsRemoteSource {
  ...
  @override
  Future<EventsResponseDataModel> getIdFromEvent({required int id}) async {
    var response = await methodRequest(
    ...
    var featureResponseModel = FeatureEventsResponseDataModel.fromJson(response.body);
    return EventsDataMapper.fromFeatureEventsResponseDataModel(featureResponseModel);
  }
}